                                ...
                                <table id="kt_datatable" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <thead>
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-80px">{{ __('Company') }}</th>
                                            <th class="min-w-80px">{{ __('Name') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr form_id = "{{ $item['id'] }}" form_name = "{{ $item['form_name'] }}" form_active = "{{ $item['active'] }}" company_id = "{{ $item['company_id'] }}">
                                            <td>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form" class="form" action="#">
                    ...
                    <div class="flex-column mb-8 fv-row">
                        <!--begin::Label-->
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">{{ __('Company') }}</span>
                        </label>
                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Selecteer" name="m_company_id" id="m_company_id"> 
                            @foreach($companies as $item)
...
@push('scripts')
    <script src="{{ asset('js/survey/admin_enquentes.js')}}"></script>
@endpush
