        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                @if($user['role'] == 'Admin')
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Illuminate\Support\Facades\Route::is('admin_user_management')?'active':'' }}" href="{{ route('admin_user_management') }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Illuminate\Support\Facades\Route::is('admin_trainee_management')?'active':'' }}" href="{{ route('admin_trainee_management') }}">
                            <span class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16.0173 9H15.3945C14.2833 9 13.263 9.61425 12.7431 10.5963L12.154 11.7091C12.0645 11.8781 12.1072 12.0868 12.2559 12.2071L12.6402 12.5183C13.2631 13.0225 13.7556 13.6691 14.0764 14.4035L14.2321 14.7601C14.2957 14.9058 14.4396 15 14.5987 15H18.6747C19.7297 15 20.4057 13.8774 19.912 12.945L18.6686 10.5963C18.1487 9.61425 17.1285 9 16.0173 9Z" fill="currentColor"/>
                                    <rect opacity="0.3" x="14" y="4" width="4" height="4" rx="2" fill="currentColor"/>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Illuminate\Support\Facades\Route::is('admin_enquetes')||Illuminate\Support\Facades\Route::is('admin_distributie')?'show':'' }}">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link {{ Illuminate\Support\Facades\Route::is('admin_enquetes')?'active':'' }}" href="{{ route('admin_enquetes') }}">
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Illuminate\Support\Facades\Route::is('admin_distributie')?'active':'' }}" href="{{ route('admin_distributie') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
