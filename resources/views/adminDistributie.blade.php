                        ...
                        <div class="card-header border-0 pt-5">
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1 me-5 w-200px">
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Selecteer een Company..." name="sel_company" id="sel_company">
...
@push('scripts')
    <script src="{{ asset('js/survey/admin_distriutie.js')}}"></script>
@endpush
