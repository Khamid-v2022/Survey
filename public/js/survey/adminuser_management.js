...
$(function () {
            ...
            n &&
                n.validate().then(function (e) {
                    if ("Valid" == e) {
                        ...
                        let _url = "/adminuser_management/addUpdateUser";
                        ...
                        if ($("#m_user_role").val() == "Department") {
                            data["parent_id"] = $("#m_company").val();
                        }
    ...
    $("#m_company").on("change", function () {
        ...
        let _url = "/adminuser_management/userInfo/" + id;
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.code == 200) {
                    $("#m_org_type").val(response.data["org_type"]);
                } else {
                    $("#m_org_type").val("");
                }
            },
    ...
    $("#m_user_role").on("change", function () {
        ...
        let _url = "/adminuser_management/getUserTreeByRole";

        let data = {
            role: role,
            selected_company: $("#m_company").val(),
        };
    ...
    $("#kt_datatable").on("click", ".edit-btn", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#m_company").val(data.company_id).trigger("change");
    ...
    $("#kt_datatable").on("click", ".active-company-btn", function () {
        ...
        let id = $(this).parents("tr").attr("user_id");
        let _url = "/adminuser_management/changeActive";
    ...
    $("#kt_datatable").on("click", ".delete-company-btn", function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                let _url = "/adminuser_management/deleteUser/" + id;
                $.ajax({
                    type: "DELETE",
                    url: _url,
                    success: function (data) {
